...
class ChatField {
    constructor(playground){
        ...
        this.$history = $(`<div class="ac-game-chat-field-history">Chat History</div>`);
...
class Player extends AcGameObject {
    ...
    start() {
        ...
        this.playground.notice_board.write("Ready: " + this.playground.player_count + "/3");
    ...
    add_listening_events() {
        ...
        this.playground.game_map.$canvas.keydown(function(e) {
            if(e.which === 13) {
                if(outer.playground.mode === "multi mode"){ //open chat
...
class MultiPlayerSocket {
    constructor(playground) {
        ...
        this.ws = new WebSocket("wss://app6279.acapp.acwing.com.cn/wss/multiplayer/");
...
`);
    ...
    acwing_login(){
        $.ajax({
            url: "https://app6279.acapp.acwing.com.cn/settings/acwing/web/apply_code/",
            type: "GET",
        ...
        $.ajax({
            ...
            success: function(resp){
                if(resp.result === "success"){
                    ...
                    outer.$login_error_message_html(resp.result);
                }
            }
        });
    }
    ...
    getinfo_acapp() {
        let outer = this;
        $.ajax({
            url: "https://app6279.acapp.acwing.com.cn/settings/acwing/acapp/apply_code/",
            type: "GET",
            success: function(resp) {
                if(resp.result === "success"){
