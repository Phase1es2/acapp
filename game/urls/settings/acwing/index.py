...
urlpatterns = [
    ...
    path("web/receive_code/", web_receive_code, name="setting_acwing_web_recieve_code"),
    path("acapp/apply_code/", acapp_apply_code, name="settings_acwing_acapp_apply_code"),
    path("acapp/receive_code/", acapp_receive_code, name="setting_acwing_acapp_recieve_code"),
]
